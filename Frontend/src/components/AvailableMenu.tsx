    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-4 sm:px-0">
        {menus?.map((menu: MenuItem, index: number) => (
          <Card
            key={menu._id}
            className={`group bg-white dark:bg-slate-800 border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 sm:hover:-translate-y-3 hover:rotate-1 rounded-xl sm:rounded-2xl overflow-hidden relative ${
          ...
          >
            ...
            <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm leading-relaxed line-clamp-2 group-hover:line-clamp-3 transition-all duration-300">
                {menu.description}
              </p>
            ...
            <CardFooter className="p-4 sm:p-6 pt-0">
              <Button
                ...
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-2.5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl group/btn relative overflow-hidden text-sm sm:text-base"
              >
